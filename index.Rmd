...
Through correlation analysis among neuropsychological score and dynamic metrics, we found many significant correlation. This suggested it might be necessary to dive in more about their relationships (See results below), especially we can take age into account. We will talk more about this in the regression section.
...
In terms of regression analysis, we found many fignificant effect. Without surprising, age is always a significant effect when combining wih any independent variable. Resulst are sumarized below. It's worth to note that when adding the interaction term between age and independent variable, none of them had a huge change in their main effect and none interaction was significant. This suggested a non-existence of confounding effect. 
...
- In addition to validate the methodology used by previous study (Hilbert transformation and clustering analysis), We further identified many significant effects between identified networks and correlation with cognitive capabilities have. More importantly, those effects are adjusted by the aging effect
...
We decide to open source our code for future researchers. Please research out any of contributors listed above if you have any questions
